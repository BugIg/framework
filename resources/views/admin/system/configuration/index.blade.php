...
@section('pageTitle')
    {{ __('avored-admin::system.terms.configuration') }}
@endsection
...
@section('actions')
    <div class="flex justify-start">
         <span class="inline-flex rounded-md shadow-sm">
            <button type="submit"
                    onclick="document.getElementById('configuration-save').submit()"
...
@section('content')
    ...
    <div class="w-full mx-auto px-4 sm:px-6 md:px-8">
        <div class="py-4">
            <form id="configuration-save" method="post" action="{{ route('admin.configuration.store') }}">
                @csrf
