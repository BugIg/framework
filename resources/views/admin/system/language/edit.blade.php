...
@section('pageTitle')
    {{ __('avored-admin::system.language.edit-title') }}
@endsection
...
@section('actions')
    <div class="flex justify-start">
         <span class="inline-flex rounded-md shadow-sm">
            <button type="submit"
                    onclick="document.getElementById('language-save').submit()"
...
@section('content')
    ...
    <div class="w-full mx-auto px-4 sm:px-6 md:px-8">
        <div class="py-4">
            <form id="language-save" method="post" action="{{ route('admin.language.update', $language->id) }}">
                @csrf
                @method('put')
