...
@section('pageTitle')
    {{ __('avored-admin::system.comms.edit') . ' ' .  __('avored-admin::system.terms.product') }}
@endsection
...
@section('actions')
    <div class="flex justify-start">
         <span class="inline-flex rounded-md shadow-sm">
            <button type="submit"
                    onclick="document.getElementById('product-save').submit()"
...
@section('content')
    ...
    <div class="w-full mx-auto px-4 sm:px-6 md:px-8">
        <div class="py-4">
            <form id="product-save" method="post" action="{{ route('admin.product.update', $product->id) }}">
                @csrf
                @method('put')
