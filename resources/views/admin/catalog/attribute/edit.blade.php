...
@section('pageTitle')
    {{ __('avored-admin::catalog.attribute.edit-title') }}
@endsection
...
@section('actions')
    <div class="flex justify-start">
         <span class="inline-flex rounded-md shadow-sm">
            <button type="submit"
                    onclick="document.getElementById('attribute-save').submit()"
...
@section('content')
    ...
    <div class="w-full mx-auto px-4 sm:px-6 md:px-8">
        <div class="py-4">
            <form id="attribute-save" method="post" action="{{ route('admin.attribute.update', $attribute->id) }}">
                @csrf
                @method('put')
