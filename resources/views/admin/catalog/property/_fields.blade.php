...
<x-avored-field
    label="avored-admin::system.comms.data_type"
    for="data_type"
>
    <x-avored-select
        name="data_type"
...
<x-avored-field
    label="avored-admin::system.comms.field_type"
    for="field_type"
>
    <x-avored-select
        v-model="fieldType"
...
<x-avored-field
    :label="__('avored-admin::system.comms.use_for_all_products')"
    for="is_default"
>
    <avored-toggle
...
<x-avored-field
    :label="__('avored-admin::system.comms.use_for_category_filter')"
>
    <avored-toggle
...
<x-avored-field
    label="avored-admin::system.comms.is_visible_frontend"
>
    <avored-toggle
...
<x-avored-field
    label="avored-admin::system.comms.sort_order"
    for="sort_order"
>
    <x-avored-input
        name="sort_order"
