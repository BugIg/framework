                ...
                <div class="max-w-md w-full">
                    <div>
                        ...
                        <h2 class="mt-6 text-center text-3xl leading-9 font-extrabold text-gray-900">
                            {{ __('avored-admin::user.auth.update.title') }}
                        </h2>
                    ...
                    <form method="POST" action="{{ route('admin.password.update') }}">
                        ...
                        <div class="rounded-md shadow-sm">
                            ...
                            <div class="mt-3">
                                <a-input
                                    ...
                                    :errors="{{ $errors }}"
                                    class="placeholder-gray-500"
                                    placeholder="{{ __('avored-admin::user.auth.update.password') }}"
                                ></a-input>
                            ...
                            <div class="mt-3">
                                <a-input
                                    ...
                                    :errors="{{ $errors }}"
                                    class="placeholder-gray-500"
                                    placeholder="{{ __('avored-admin::user.auth.update.confirm-password') }}"
                                ></a-input>
                        ...
                        <div class="mt-6">
                            ...
                            <span class="absolute left-0 inset-y pl-3">
                                ...
                                {{ __('avored-admin::user.auth.update.reset-btn') }}
                            </button>
                        </div>
                    </form>
                </div>
